...
| `arr_submitted_name` | `Example Show Season 01 S01 1080p WEB-DL x265`      |
| `infohash`           | `abc123def456...`                                   |

`arr_submitted_name` uses the release name sent by Sonarr, Radarr, or another client, such as the `dn`
value in a magnet link or the uploaded torrent/NZB filename. Decypharr sanitizes this value before
creating the folder.
